...
export default function BouncieIntegration({ vehicles, notify }) {
  ...
  const disconnect = async () => {
    if (!window.confirm('Disconnect Bouncie? Existing location history will remain in Fleeterbase.')) return;
    setBusy(true);
