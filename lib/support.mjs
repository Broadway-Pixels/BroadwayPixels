...
export async function sendSupportEmails(submission, ticketId, env, fetchImpl = fetch) {
  ...
  const logoUrl = env.SUPPORT_LOGO_URL || "https://broadwaypixels.com/assets/broadway-pixels-favicon.png?v=20260722-2";
  ...
  const adminHtml = `
    ...
    <img src="${logoUrl}" alt="Broadway Pixels" width="72" height="72" style="display:block;border-radius:50%;margin-bottom:24px">
  ...
  const confirmationHtml = `
    <div style="font-family:Arial,sans-serif;color:#10224a;line-height:1.6;max-width:620px;margin:auto">
      <img src="${logoUrl}" alt="Broadway Pixels" width="84" height="84" style="display:block;border-radius:50%;margin-bottom:24px">
      <p style="color:#1557d6;font-weight:700;margin:0">Ticket ${safeTicketId}</p>
